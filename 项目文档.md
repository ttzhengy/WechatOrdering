...
- 通过id修改某个商品类目：void updateProductCategory(ProductCategory productCategory)

#### 商品信息

ProductCategoryCategoryDao接口

- 通过id查询单个商品：ProductInfo selectById(String id)
...
- 通过id修改某个商品：boolean updateProductInfo(ProductInfo productInfo)
